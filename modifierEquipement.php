<?php
	...
	if (
		...
		if (
            ...
            header('refresh:5;url=afficherEquipements.php');
        }
        else
...
<html>
	...
	<body>
		...
		<?php
			if (isset($_GET['id'])){
				$user = $EquipementC->recupererEquipement($_GET['id']);
		...
		<form action="" method="POST">
            <table align="center">
				...
				<tr>
					<td>
						<label for="typeeq">type equipement:
						</label>
					</td>
					<td>
						<input type="text" name="typeeq" id="typeeq" maxlength="20" value = "<?php echo $user['Typeeq']; ?>">
					</td>
				</tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td rowspan='2' colspan='1'>information de la connection</td>
                    <td>
                        <label for="prix">prix:
                        </label>
                    </td>
