...
$sql = 'SELECT name from profession ORDER BY name DESC' ;
...
include_once 'ajouterprofession.php';
                    ...
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col-md-6 col-lg-3 col-xl-2 col-6">
                            <div class="header-logo">
                                <a href="register.php"><img src="assets/images/logo/logo2.png" alt="Site Logo" /></a>
                            </div>
                        </div>
                        <!-- Header Logo End -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-8 m-auto">
                    ...
                    <form method="POST" onsubmit="return Registration_Checker()" action="AjouterEmploye.PHP">
                        ...
                        <!-- Form Action Start -->
                            ...
                            <!-- Input Password 2 Start -->
                            <div class="single-input-item mb-3">
                            <label>Confirm your Password</label>
                                <input type="password" name="password1" id="password1" placeholder="Confirm your Password"  required>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                           ...
                           <div class="col-lg-6">
                            ...
                            <div class="single-input-item mb-3">
                                <button class="btn btn btn-dark btn-hover-success rounded-0" name="submit"   >Register</button>
                            </div>
