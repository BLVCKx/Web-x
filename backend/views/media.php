                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="media.php?id=<?PHP echo $prod['id']; ?>">
                                            <button type="submit" class="btn btn-default" value="modify">Modifier</button>
                                        </form>
                                    </td>
                                    <td>
                                        <form method="POST" action="supprimerProduit.php">
                                            <button type="submit" class="btn btn-default" value="delete">suprimer</button>
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="category" name="category" value="<?php echo $prod['quantity']; ?>"
                                            ...
                                            <option value="protein" name="protein" id="protein">gratuit</option>
                                            <option value="mechanical" name="mechanical" id="mechanical">payant
                                                </option>
