            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="plugins/images/users/profil.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="plugins/images/users/profil.jpg"
                                                class="thumb-lg img-circle" alt="img"></a>
                                        <h4 class="text-white mt-2"><?php echo $row->first_name;?></h4>
                                        <h5 class="text-white mt-2"><?php echo $row->email;?></h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            <button type="submit" class="btn btn-success" name="up-btn">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
