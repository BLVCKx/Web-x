...
<?php foreach($query as $q){?>
    <div class="bg-warning p-5 rounded-lg text-white text-center">
        <h1><?php echo $q['title'];?></h1>

        <div class="d-flex mt-2 justify-content-center align-items-center">
            <a href="http://localhost/github/back-admin/frayedit.php?id=<?php echo $q['id']?>" class="btn btn-primary btn-sm" name="edit">Edit</a>
            <form method="POST">
...
<a href="../BACK-ADMIN/dashboard.php" class="btn btn-outline-success my-3">Go Back</a>
