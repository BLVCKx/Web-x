...
<form action="" method="GET"> 
     <div class="col-md-6">
        <input type="text" name="search" class='form-control' placeholder="Search..." maxlength="30" size="40"  value=<?php echo @$_GET['search']; ?> > 
...
<div class="snip1265">
        <div class="plan">
          ...
          <div class="plan-select"><a href="login.php">ACHETER</a></div>
        </div>
