...
if (
    ...
    !empty($_POST["quantite"])
        ...
        $equipementC->modifierequipement($user,$_GET['id_equipement']);
        
        header('Location:../View/afficher_equipement.php');
        header('refresh:5;url=afficher_equipement.php');
    } else
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                if (isset($_GET['id_equipement'])) {
                    $user = $equipementC->recupererequipement($_GET['id_equipement']);
                ?>
                        ...
                        <div>
                            <form method="POST" action="">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="id_equipement" id="id_equipement" value="<?php echo $user['id_equipement']; ?>" readonly>
                                </div>

                                <div class="form-group">
                                    <label for="nom_equipement">nom_equipement</label>
                                    <input type="text" class="form-control" name="nom_equipement" id="nom_equipement" value="<?php echo $user['nom_equipement']; ?>">
                                </div>
