...
<body>
 ...
 <!-- ============================================================== -->
	...
	<div class="container">
		<div class="box">
			<h4 class="display-4 text-center">Planning</h4><br>
			...
			<table class="table table-striped">
			  ...
			  <tbody>
			    ...
			    <tr>
			      <th scope="row"><?=$i?></th>
			      <td><?=$rows['date']?></td>
			      <td><?php echo $rows['beneficiaire'];?></td>
			      <td><?php echo $rows['veterinaire'];?></td>
			...
			<div class="link-right">
				<a href="http://localhost/github/cruz2/fr.php" class="link-primary">back</a>
			</div>
		</div>
	</div>
 <!-- footer -->
