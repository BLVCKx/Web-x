...
<body>
	<div class="container">
		<div class="box">
			<h4 class="display-4 text-center">facture</h4><br>
			...
			<div class="link-right">
				<a href="index.php" class="link-primary">send</a>
			</div>
			<div class="text-center">
        <button onclick="window.print();" class="btn btn-primary" id="print-btn">Print et pdf </button>
      </div>
		</div>
	</div>
