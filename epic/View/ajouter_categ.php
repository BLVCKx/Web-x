    ...
    <!-- Breadcrumb Section End -->
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../assets/forms/ajouter_categorie.html" class="nav-link active">
...
<script type="text/javascript">
  function test()
  {
    if (document.myform.nom_categ.value.length == 0)
    {
    ...
    {
        if (document.myform.descriptionc.value.length == 0)
        {
        alert("veuillez remplir le champ");
        }
       else
        {
       alert("Ajout accomplie avec succées ! ");
        }
