...
$listeequipement=$equipement->trierequipement();
    ...
    <!-- Breadcrumb Section End -->
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../View/afficher_equipement.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mes Tables</p>
                </a>
              </li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">trier equipement </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  $(function () {
    ...
    $('#example2').DataTable({
      ...
      "responsive": true,
				...
				<button class="btn btn-primary" onclick="print('http://localhost/Projet1/View/afficher_equipement.php')">Imprimer le PDF</button>
