...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
		<div class="box">
			<h4 class="display-4 text-center">veterinary</h4><br>
            <a href="http://localhost/github/interv_rud/read.php" class="btn btn-light btn-hover-info w-100"> planning</a>
			...
			<div class="link-right">
				<a href="index.php" class="link-primary btn-info">Create</a>
			</div>
		</div>
	</div>
