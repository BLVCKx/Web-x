...
<body>
	...
	<div class="container">
		<form action="php/create.php" 
		   ...
		   <h4 class="display-4 text-center">Nouveau Véterinaire</h4><hr><br>
		   ...
		   <div class="form-group">
		    ...
		    <div class="form-group">
		     ...
		     <input type="text" 
		           ...
		           id="adresse" 
		           name="adresse" 
		           value="<?php if(isset($_GET['adresse']))
		                           echo($_GET['adresse']); ?>"
		   ...
		   <div class="form-group">
		     ...
		     <input type="text" 
		           ...
		           id="num_tel" 
		           name="num_tel" 
		           value="<?php if(isset($_GET['num_tel']))
		                           echo($_GET['num_tel']); ?>"
		   ...
		   <div class="form-group">
		     ...
		     <input type="text" 
		           ...
		           id="spec" 
		           name="spec" 
		           value="<?php if(isset($_GET['spec']))
		                           echo($_GET['spec']); ?>"
		           placeholder="Confirmez votre Spécialité">
		   </div>
           ...
           <div class="form-group">
             ...
             <input type="text" 
                   ...
                   id="couverture" 
                   name="couverture" 
                   value="<?php if(isset($_GET['couverture']))
                                   echo($_GET['couverture']); ?>"
                   placeholder="Confirmez votre Couverture">
           </div>
		   ...
		   <button type="submit" 
		    ...
		    <a href="fr.php" class="link-primary">back</a>
        </center>
	    </form>
	</div>
<!-- footer -->
