...
<body>
    ...
    <div class="section section-margin">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12" data-aos="fade-up" data-aos-delay="500">
                                            <button type="submit" id="submit" name="submit" class="btn btn-success button-hover-primary">Send </button>
                                            <button type="submit" id="submit1" name="submit1" class="btn btn-warning button-hover-primary">Edit </button>
                                            <button type="submit" id="submit2" name="submit2" class="btn btn-danger button-hover-primary">Delete</button>
                                        </div>
		...
		<form action="php/create.php" 
		   ...
		   <h4 class="display-4 text-center">don't think twice</h4><hr><br>
		   ...
		   <div class="form-group">
		     <label for="name">what do you think about us ?</label>
		     <input type="text" 
             <textarea id="body" rows="5" 
		           ...
		           value="<?php if(isset($_GET['email']))
		                           echo($_GET['email']); ?>"
		           placeholder="free to speak">
                   <br><br>
		   </div>
<center>
		   <button type="submit" 
		          class="btn btn-primary"
		          name="create">send</button>
            ...
            <a href="index2.php" class="btn btn-success">send an email</a>
                        ...
                        <h2 class="title">what you should know</h2></center>

                        </div>
                    <!-- Section Title End -->
                    <center><div class="">
                        <p >if something happen here we can't help bro sorry</p>
                        <address class="">
                            <ul>
                                <li ><i class="fa fa-fax"></i> Your address goes here</li>
                                <li ><i class="fa fa-phone"></i> <a href="tel:+216-26-490-129">+216 26 49 01 29</a></li>
                                <li ><i class="fa fa-envelope-o"></i> <a href="mailto:fray@example.com">fray@example.com </a></li>
                            </ul>
                        </address>
