<?php
    ...
    include "Web-x-GestionBlog/logic.php";
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12">
                        <div class="header-top-msg-wrapper text-center">
                            <p class="header-top-message text-center">Up to 50% off for <strong>Summmer</strong> Collections <a href="wez/shop.php" class="btn btn-hover-dark btn-secondary bg-success">Shop Now</a></p>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        <img src="images/plant.jpg" alt="Slider Image" />
                    </div>
                    <div class="container">
                        <div class="hero-slide-content">
                            <h2 class="title m-0 text-white">Get -30% off</h2>
                            <p>Latest plant product & product collections.</p>
                            <a href="wez/shop.php" class="btn btn-success btn-hover-light">Shop Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        <img src="images/equipement.jpg" alt="Slider Image" />
                    </div>
                    <div class="container">
                        <div class="hero-slide-content">
                            <h2 class="title m-0 text-white"> New Arrivals Equipement <br />Get flat 50% off </h2>
                            <a href="shop.html" class="btn btn-success btn-hover-light">Shop Now</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-n6">
                ...
                <div class="col-md-6 col-12 mb-6 pe-lg-2 pe-md-3">
                    <a href="shop.html" class="banner" data-aos="fade-up" data-aos-delay="200">
                        <img src="images/farm.jpg" alt="Banner Image" />
                    </a>
                </div>
                <!-- Banner End -->
                ...
                <div class="col-md-6 col-12 mb-6 ps-lg-2 ps-md-3">
                    <a href="shop.html" class="banner" data-aos="fade-up" data-aos-delay="400">
                        <img src="images/farm2.jpg" alt="Banner Image" />
                    </a>
                </div>
                <!-- Banner End -->
                    ...
                    <div class="testimonial-carousel" data-aos="fade-up" data-aos-delay="400">
                        <div class="swiper-container testimonial-gallery-thumbs">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="images/kiwi.jpg" alt="Product Image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="images/orange.jpg" alt="Product Image">
                                </div>
                                <div class="swiper-slide">
                                    <img src="images/potato.jpg" alt="Product Image">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="testimonial-content text-center">
                                        ...
                                        <span class="ratings justify-content-center mb-4">
												<span class="rating-wrap text-white">
													<span class="star text-warning" style="width: 80%"></span>
                                        </span>
                                        <span class="rating-num text-light">(4)</span>
                                        </span>
                                        <h4 class="testimonial-author mb-0">Fray Mhamed</h4>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="testimonial-content text-center">
                                        ...
                                        <h4 class="testimonial-author mb-0">Mehdi belakhel</h4>
                                    </div>
                                    <!-- Testimonial Content End -->
                                </div>
                                <div class="swiper-slide">
                                    ...
                                    <div class="testimonial-content text-center">
                                        ...
                                        <h4 class="testimonial-author mb-0">Nermin ayad</h4>
                                    </div>
                                    <!-- Testimonial Content End -->
                                </div>
                                <div class="swiper-slide">
                                    ...
                                    <div class="testimonial-content text-center">
                                        ...
                                        <h4 class="testimonial-author mb-0">Jawher Trablesi</h4>
                                    </div>
                                    <!-- Testimonial Content End -->
                                </div>
                            </div>
...
<span></span>
    ...
    <div class="section">
        <div class="container">
           ...
           <a href="Web-x-GestionBlog/create.php" class="btn btn-outline-dark">+ Create a new blog</a>
        </div> 
        </form>
                    <!-- Section Title End -->
                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center">
                    <div class="card text-white bg-success mt-5" style="width: 18rem;">
                        <div class="card-body">
                           ...
                           <center> <h1 class="btn btn success"><?php echo $q['title'];?></h1></center>
                            <p class="card-text"><?php echo substr($q['content'], 0, 10);?>...</p>
                            <a href="Web-x-GestionBlog/view.php?id=<?php echo $q['id']?>" class="btn btn-light">Read More <span class="text-danger">&rarr;</span></a>
                        </div>
                    </div>
                </div>
            <?php }?>
                        ...
                        <div class="brand-logo-carousel arrow-outside-container">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <!-- Single Brand Logo Start -->
                                    <div class="swiper-slide single-brand-logo">
                                        <a href="#"><img src="images/2.png" alt="Brand Logo"></a>
                                    </div>
                                    <!-- Single Brand Logo End -->
                                    ...
                                    <!-- Single Brand Logo Start -->
                                    <div class="swiper-slide single-brand-logo">
                                        <a href="#"><img src="images/5.jpg" alt="Brand Logo"></a>
                                    </div>
                                    <!-- Single Brand Logo End -->
