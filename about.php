            ...
            <div class="row align-items-center mb-n6">
                ...
                <div class="col-lg-5 mb-6">
                    ...
                    <div class="about-thumb" data-aos="fade-up" data-aos-delay="200">
                        <img class="fit-image" src="images/Asset1.png" alt="About Image">
                    </div>
                    <!-- About Thumb End -->
            ...
            <div class="row">
                <div class="col-12" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="section-title text-center">
                        ...
                        <p class="sub-title mt-2">Accumsan vitae pede lacus ut ullamcorper sollicitudin quisque libero</p>
                    </div>
                    <!-- Section Title End -->
            ...
            <div class="row mb-n6">
                <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="single-choose-item text-center mb-6">
                        ...
                        <h4 class="cta-title">Free Shipping</h4>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="single-choose-item text-center  mb-6">
                        ...
                        <h4 class="cta-title">Fast Delivery</h4>
                        <p>Amadea Shop is a very slick and clean e-commerce template with endless possibilities.</p>
                    </div>
                </div>
...
<center>
                <div class="row mb-n1">
                    ...
                    <div class="single-team-member text-center mb-6">
                        ...
                        <div class="team-content">
                            <h6 class="team-member-name ">1</h6>
                            <p>CEO</p>
                        </div>
                        <!-- Team Content End -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="single-team-member text-center mb-6">
                        ...
                        <!-- Team Content Start -->
                        <div class="team-content">
                            <h6 class="team-member-name">2</h6>
                            <p>Designer</p>
                        </div>
                        <!-- Team Content End -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="single-team-member text-center mb-6">
                        ...
                        <!-- Team Content Start -->
                        <div class="team-content">
                            <h6 class="team-member-name">3</h6>
            ...
            <div class="row mb-n6">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="single-team-member text-center mb-6">
                        ...
                        <!-- Team Content Start -->
                        <div class="team-content">
                            <h6 class="team-member-name">4</h6>
                            <p>CEO</p>
                        </div>
                        <!-- Team Content End -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="single-team-member text-center mb-6">
                        ...
                        <!-- Team Content Start -->
                        <div class="team-content">
                            <h6 class="team-member-name">5</h6>
                            <p>Designer</p>
                        </div>
                        <!-- Team Content End -->
                ...
                <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="single-team-member text-center mb-6">
                        ...
                        <!-- Team Content Start -->
                        <div class="team-content">
                            <h6 class="team-member-name">6</h6>
                            <p>Marketing Officer</p>
                        </div>
                        <!-- Team Content End -->
