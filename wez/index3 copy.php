                                ...
                                <ul>
                                    <li class="has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="index_2.php">Home 2</a></li>
            ...
            <div class="row mt-10 mb-n10">
                <div class="col-lg-6 mb-10">
                    <div class="delivery-date-wrapper mb-6">
                       ...
                       <h3> <span>P.S:We do not deliver during the week-end. <?php echo $_SESSION['f'];?> <?php echo $_SESSION['ph'];?></span> </h3>
					...
					?>
                                    <tr class="total">
                                        <td>Total <?php echo $_SESSION['rer'];?> </td>
                        ...
                        <input type="submit" name="submit2" class="btn btn-info btn-large" value="Submit2">
