...
<body>
 ...
 <div class="container jumbotron">
       <center>
		<h4 class="btn btn-success btn-hover-light">
		   continue shopping 
		   <span style="margin-left: 30px;">
		   	     <a href=shop.php ><i class="fa fa-plus" data-toggle="modal" data-target="#myModal"></i></a>
                    </center> 
		   </span>
		</h4>
            ...
            <div class="row mt-10 mb-n10">
                    ...
                    <div class="delivery-date-wrapper mb-6">
                        ...
                        <form action="add2.php" method="POST">
                                        <div class="single-input-item mb-3">
                                            <label for="add" class="required mb-1">Address <span class="required">*:</span></label>
                                            <input placeholder="address" type="text" name="adddress" id="adddress">
                                        </div>
                                
                                  
                                  
                        
                       <h3> <span>P.S:We do not deliver during the week-end.</span> </h3>
                    </div>
                ...
                <div class="col-lg-6 mb-10">
					...
					?>
                                    <tr class="total">
                                        <td>Total</td>
                                        <td align="right" name="fox">TND <?php echo number_format($total, 2); ?></td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <input type="submit" name="submit2" class="btn btn-success btn-hover-light" value="Checkout">
